        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Ajouter admin</li>
            </ol>
          </div>
                ...
                <div class="card-body">
                  <form method="POST" action="">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="nom" class="form-control" id="nom" placeholder="Nom du admin" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="prenom" class="col-sm-3 col-form-label">Prenom</label>
                      <div class="col-sm-9">
                        <input type="text" name="prenom" class="form-control" id="prenom" placeholder="prenom du admin" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="email" class="col-sm-3 col-form-label">CIN</label>
                      <div class="col-sm-9">
                        <input type="text"  name="cin" class="form-control" id="email" placeholder="Num cin" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="telephone" class="col-sm-3 col-form-label">Nom d'tilisateur:</label>
                      <div class="col-sm-9">
                        <input type="tel"  name="username" class="form-control" id="telephone" placeholder="nom_prenom" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <label for="motdepasse1" class="col-sm-3 col-form-label">Repeter mot de passe</label>
                      <div class="col-sm-9">
